...
function do_gui()
	...
	if previous_hovered() then
		...
		show_tooltip( function()
			...
			GuiZSetForNextWidget( gui, -100 )
			GuiColoredText( gui, 0.5, 0.5, 0.5, 1.0, 0, 0, version )
		end, x - 5 - 2 - 3, y + 10 )
		GuiZSet( gui, 100 )
		...
		GuiLayoutBeginVertical( gui, 0, 360 * 0.02, true )
			...
			GuiLayoutBeginHorizontal( gui, horizontal_centered_x(9,4), percent_to_ui_scale_y(2), true )
				...
				do_custom_tooltip( function()
					...
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_numbers_are" ) )
					GuiColorSetForNextWidget( gui, color(0,207,40,255) )
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_last_frame_damage" ) )
					GuiColorSetForNextWidget( gui, color(208,208,248,255) )
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_average_dps" ) )
					GuiColorSetForNextWidget( gui, color(255,85,0,255) )
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_total_damage" ) )
					GuiColorSetForNextWidget( gui, color(208,208,248,255) )
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_dps" ) )
					GuiColorSetForNextWidget( gui, color(126,126,126,255) )
					GuiText_Old( gui, 0, 0, wrap_key( "target_dummy_highest_dps" ) )
				end, 3, 0, true )
