...
local function get_caller()
	return finfo(setfenv(3, getfenv(3))).source
end
...
function this_folder()
	return extract_folder(get_caller())
end
...
function module_path()
	return extract_module_path(get_caller())
end

local extract_module_name = memoize(function(source)
	return source:match "^mods/[^/]+/files/([^/]+)/"
end)

---@return string
function module_name()
	return extract_module_name(get_caller())
end
