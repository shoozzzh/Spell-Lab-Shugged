			...
			settings = {
				...
				},
				{
					...
					settings = {
						...
						{
							id             = "shortcut_delete_spell",
							ui_name        = text.shortcut_delete_spell,
